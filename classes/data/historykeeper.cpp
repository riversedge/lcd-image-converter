...
HistoryKeeper::HistoryKeeper(QObject* parent) : QObject(parent)
{
...
void HistoryKeeper::init(const QStringList* keys, const QMap<QString, QImage*>* images,
...
void HistoryKeeper::store(const QStringList* keys, const QMap<QString, QImage*>* images,
                          const QMap<QString, QVariant>* info)
{
...
void HistoryKeeper::restorePrevious(QStringList* keys, QMap<QString, QImage*>* images, QMap<QString, QVariant>* info)
{
  if (this->mCurrentIndex < 0) {
    qDebug() << "history keeper not initialized";
    return;
...
void HistoryKeeper::restoreNext(QStringList* keys, QMap<QString, QImage*>* images, QMap<QString, QVariant>* info)
{
  if (this->mCurrentIndex < 0) {
    qDebug() << "history keeper not initialized";
    return;
...
bool HistoryKeeper::initialized() const { return (this->mCurrentIndex >= 0); }

bool HistoryKeeper::canRestorePrevious() const { return (this->mCurrentIndex > 0); }

bool HistoryKeeper::canRestoreNext() const { return (this->mCurrentIndex < (this->mHistory->length() - 1)); }
...
void HistoryKeeper::restoreAt(int index, QStringList* keys, QMap<QString, QImage*>* images,
